...
./identifyCrisprSite.sh ../analysis/assignment/CrisprReady ../analysis/assignment/PreCrispr > ../analysis/assignment/identifyCrisprSite.txt
./editGenome.sh ../analysis/assignment/PreCrispr ../analysis/assignment/PostCrispr > ../analysis/assignment/editGenome.txt
python3 exomeReport.py ../data/assignment/clinical_data.txt ../analysis/assignment/PostCrispr --report ../analysis/assignment/exomeReport.txt