...
./createCrisprReady.sh ../data/assignment/motif_list.txt ../analysis/assignment/exomesCohort ../analysis/assignment/TopMotifs > ../analysis/assignment/createCrisprReady.txt
